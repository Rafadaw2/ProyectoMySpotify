 ...
 */
final class Version20250126194000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE perfil (id INT AUTO_INCREMENT NOT NULL, estilo_musica_preferido_id INT DEFAULT NULL, foto VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, INDEX IDX_9665764732B6D0FD (estilo_musica_preferido_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, perfil_id INT NOT NULL, email VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, nombre VARCHAR(30) NOT NULL, fecha_nacimiento DATE NOT NULL, UNIQUE INDEX UNIQ_2265B05D57291544 (perfil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE perfil ADD CONSTRAINT FK_9665764732B6D0FD FOREIGN KEY (estilo_musica_preferido_id) REFERENCES estilo (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE perfil DROP FOREIGN KEY FK_9665764732B6D0FD');
